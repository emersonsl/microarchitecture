...
module processor_mm_interconnect_0 (
	...
	wire         cmd_mux_003_src_valid;                                                              // cmd_mux_003:src_valid -> pin_saida_s1_agent:cp_valid
	wire  [91:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pin_saida_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                              // pin_saida_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [4:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> pin_saida_s1_agent:cp_channel
	wire         cmd_mux_003_src_startofpacket;                                                      // cmd_mux_003:src_startofpacket -> pin_saida_s1_agent:cp_startofpacket
	wire         cmd_mux_003_src_endofpacket;                                                        // cmd_mux_003:src_endofpacket -> pin_saida_s1_agent:cp_endofpacket
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> pin_entrada_s1_agent:cp_valid
	wire  [91:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> pin_entrada_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // pin_entrada_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [4:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> pin_entrada_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> pin_entrada_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> pin_entrada_s1_agent:cp_endofpacket
	...
	wire         pin_saida_s1_agent_rp_valid;                                                        // pin_saida_s1_agent:rp_valid -> router_005:sink_valid
	wire  [91:0] pin_saida_s1_agent_rp_data;                                                         // pin_saida_s1_agent:rp_data -> router_005:sink_data
	wire         pin_saida_s1_agent_rp_ready;                                                        // router_005:sink_ready -> pin_saida_s1_agent:rp_ready
	wire         pin_saida_s1_agent_rp_startofpacket;                                                // pin_saida_s1_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire         pin_saida_s1_agent_rp_endofpacket;                                                  // pin_saida_s1_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire         pin_entrada_s1_agent_rp_valid;                                                      // pin_entrada_s1_agent:rp_valid -> router_006:sink_valid
	wire  [91:0] pin_entrada_s1_agent_rp_data;                                                       // pin_entrada_s1_agent:rp_data -> router_006:sink_data
	wire         pin_entrada_s1_agent_rp_ready;                                                      // router_006:sink_ready -> pin_entrada_s1_agent:rp_ready
	wire         pin_entrada_s1_agent_rp_startofpacket;                                              // pin_entrada_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         pin_entrada_s1_agent_rp_endofpacket;                                                // pin_entrada_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire         pin_saida_s1_agent_rdata_fifo_src_valid;                                            // pin_saida_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire  [33:0] pin_saida_s1_agent_rdata_fifo_src_data;                                             // pin_saida_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire         pin_saida_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_003:in_0_ready -> pin_saida_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_003_out_0_valid;                                                  // avalon_st_adapter_003:out_0_valid -> pin_saida_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_003_out_0_data;                                                   // avalon_st_adapter_003:out_0_data -> pin_saida_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_003_out_0_ready;                                                  // pin_saida_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire   [0:0] avalon_st_adapter_003_out_0_error;                                                  // avalon_st_adapter_003:out_0_error -> pin_saida_s1_agent:rdata_fifo_sink_error
	wire         pin_entrada_s1_agent_rdata_fifo_src_valid;                                          // pin_entrada_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] pin_entrada_s1_agent_rdata_fifo_src_data;                                           // pin_entrada_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         pin_entrada_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_004:in_0_ready -> pin_entrada_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> pin_entrada_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> pin_entrada_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // pin_entrada_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> pin_entrada_s1_agent:rdata_fifo_sink_error
	...
	processor_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	processor_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
